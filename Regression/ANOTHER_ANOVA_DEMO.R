...
growth_A <- rnorm(5, mean = 23, sd = 4)  # Fertilizer A
growth_B <- rnorm(5, mean = 23, sd = 4.4)   # Fertilizer B
growth_C <- rnorm(5, mean = 22, sd = 4)   # Fertilizer C
growth_D <- rnorm(5, mean = 22, sd = 4.3)  # Fertilizer D
growth_E <- rnorm(5, mean = 23, sd = 3.8)   # Fertilizer E
